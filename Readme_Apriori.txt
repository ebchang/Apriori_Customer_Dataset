For the Priori algorithm, you can take a dataset and set up the variables needed by using the read() function. The Aprori function takes a dataset and a minimum support. 
